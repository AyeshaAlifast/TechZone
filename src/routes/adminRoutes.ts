...
import { getDashboard, getUsers, toggleUserStatus, changeUserRole,getProducts, getAddProduct, postAddProduct, getEditProduct, postEditProduct, deleteProduct ,getOrders, updateOrderStatus  } from "../controllers/adminController";
...
router.post("/orders/:id/status", isAuthenticated, isAdmin, updateOrderStatus);